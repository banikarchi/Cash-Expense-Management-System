...
class TravelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create travel" do
    assert_difference("Travel.count") do
      post travels_url, params: { travel: { approve: @travel.approve, category: @travel.category, expenses: @travel.expenses } }
    end
  ...
  test "should update travel" do
    patch travel_url(@travel), params: { travel: { approve: @travel.approve, category: @travel.category, expenses: @travel.expenses } }
